...
![Escaneo de puertos](Imagenes/2.PNG)
...
![Escaneo de puertos](Imagenes/3.PNG)
...
### Respuesta 2
 ...
 ![Escaneo de puertos](Imagenes/4.PNG)

 ![Escaneo de puertos](Imagenes/5.PNG)
...
![Escaneo de puertos](Imagenes/6.PNG)


Buscamos esa version de CMS en Database 

![Escaneo de puertos](Imagenes/7.PNG)

En los detalles del CVE sabemos que el codigo de CVE es 2019-9053

![Escaneo de puertos](Imagenes/8.PNG)

Descargamos el CVE 

![Escaneo de puertos](Imagenes/9.PNG)


### Respuesta 4

En el titulo del CVE  sabemos que es vulnerable a SQL injection 
![Escaneo de puertos](Imagenes/10.PNG)
...
![Escaneo de puertos](Imagenes/19.PNG)

### Respuesta 8

Accedemos utilizando ssh con el usuario y contraseña que obtuvimos
![Escaneo de puertos](Imagenes/20.PNG)
...
![Escaneo de puertos](Imagenes/21.PNG)
...
![Escaneo de puertos](Imagenes/23.PNG)
